...
INSERT INTO `bookings` VALUES (10,4,'2022-10-11',2);
...
INSERT INTO `customers` VALUES (1,'Vanessa McCarthy',NULL,NULL),(2,'Marcos Romero',NULL,NULL),(3,'Jose Antonio Blanca',NULL,NULL);
...
INSERT INTO `menu` VALUES (1,NULL,'Moussaka','Greek salad'),(2,NULL,'Manti','Kabasa');
...
INSERT INTO `orders` VALUES (1,2,20.00,NULL,NULL,NULL);
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `CancellOrder` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = cp850 */ ;
...
-- Dump completed on 2026-07-29 18:27:27
